...
const scriptTests = ["../scripts/test_check_lessons.py", "../scripts/test_lessons_seed.py", "../scripts/ci-lessons-fixture.py", "../scripts/test_validate_policies.py", "../scripts/test_drift_check.py", "../scripts/test_docs_sync.py", "../scripts/test_promote.py"]
